...
SCENARIOS = {
    ...
    # What real customers asked human agents (1,541 Park+ calls, 2026-09-21/22),
    # in the Devanagari our STT produces. One conversation, in order.
    "real_customers": [
        {"caller": "ये IDV का full form क्या है?",
         "require_any": ["Insured Declared Value", "total loss", "chori", "चोरी"]},
        {"caller": "अच्छा और NCB क्या होता है?",
         "require_any": ["No Claim Bonus", "discount", "डिस्काउंट"]},
        {"caller": "मेरी zero dep वाली है ना, उसमें engine आता है?",
         "forbid": ["haan engine bhi cover", "engine भी cover है"],
         "require_any": ["engine protect", "alag", "अलग", "app", "policy document"]},
        {"caller": "claim कैसे होगा, cashless मिलेगा?",
         "require_any": ["cashless", "garage", "claim assistant", "assist"]},
        {"caller": "third party और first party में क्या फर्क है?",
         "require_any": ["third party", "apni gaadi", "अपनी गाड़ी", "doosre", "दूसरे"]},
        {"caller": "premium बहुत ज़्यादा लग गया यार, कम हो सकता था",
         "forbid": ["कम हो जाएगा", "kam ho jayega", "discount milega"],
         "require_any": ["KYC", "payment", "team", "support"]},
        {"caller": "ठीक है ये सब details WhatsApp पे भेज दो",
         "require_any": ["WhatsApp", "app", "link"]},
    ],
    "closing": [
